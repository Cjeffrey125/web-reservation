  ...
  return (
    <div>
      ...
      <div className="flex justify-center overflow-y-scroll">
        <table
          className="w-3/4 mt-4 border rounded mb-8 shadow-md"
          style={{ borderColor: 'rgba(224, 224, 224, 0.7)' }}
        >
                ...
                <ul className="flex border-b">
                  <li
                    className={`cursor-pointer py-2 px-4 ${
                      activeTab === 'published' ? 'bg-black text-white' : ''
                    }`}
                  ...
                  <li
                    className={`cursor-pointer py-2 px-4 ${
                      activeTab === 'draft' ? 'bg-black text-white' : ''
                    }`}
            ...
            {articlesData.map((article) => (
              <tr key={article.id}>
                ...
                <td className="border-b p-2 text-center">
                  <button className="mr-2" title="Edit" style={{ backgroundColor: 'white', borderRadius: '50%' }}>
                    <BsPencil size={20} color="#525353" />
                  </button>
                  <button title="Delete" style={{ backgroundColor: 'white', borderRadius: '50%' }}>
                    <BsX size={20} color="#525353" />
                  </button>
                </td>
              </tr>
            ))}
